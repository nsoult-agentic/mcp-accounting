...
import { TAX_CONFIG, calculatePayroll } from "./payroll.js";
import {
  nextcloudUpload,
  nextcloudDownload,
  nextcloudList,
...
// TAX_CONFIG, PayrollResult, and calculatePayroll live in ./payroll.ts
// (pure logic, unit-tested in test/payroll.test.ts).
